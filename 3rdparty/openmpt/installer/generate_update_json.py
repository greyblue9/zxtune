...
plainversion = f"{OPENMPT_VERSION_MAJORMAJOR}.{OPENMPT_VERSION_MAJOR}.{OPENMPT_VERSION_MINOR}.{OPENMPT_VERSION_MINORMINOR}"
version = (
	f"{OPENMPT_VERSION_MAJORMAJOR}.{OPENMPT_VERSION_MAJOR}.{OPENMPT_VERSION_MINOR}.{OPENMPT_VERSION_MINORMINOR}"
	if OPENMPT_VERSION_MINORMINOR == "00"
	else f"{OPENMPT_VERSION_MAJORMAJOR}.{OPENMPT_VERSION_MAJOR}.{OPENMPT_VERSION_MINOR}.{OPENMPT_VERSION_MINORMINOR}-{SVNVERSION}"
)
